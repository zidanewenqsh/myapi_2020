...
from tool.utils import makedir,removepath
...
class BaseTrain(metaclass=abc.ABCMeta):
    '''
    baseai6_5:
    the sixthth version of BaseTrain class
    ...
    def _cfginit(self, cfgfile):
        ...
        self.checkPoint = self.args.checkpoint if self.args.checkpoint else self.config.getint(self.NameID, "CHECKPOINT")
